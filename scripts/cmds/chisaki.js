...
module.exports = {
  config: {
    ...
    countDown: 10,
    role: 0,
    shortDescription: "chisaki Video",
    longDescription: "chisaki Video",
    category: "Anime",
  ...
  onStart: async function ({ api, event, args }) {
    ...
    try {
      ...
      } catch { api.sendMessage(TEXT.blocked, event.threadID, event.messageID); }
