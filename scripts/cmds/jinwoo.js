...
module.exports = {
  config: {
    ...
    countDown: 10,
    role: 0,
    shortDescription: "sonjinwoo Video",
    longDescription: "sonjinwoo Video",
    category: "Anime",
  ...
  onStart: async function ({ api, event, args }) {
    ...
    const TEXT = {
      title: `${EMOJI}𝐒𝐨𝐧 𝐉𝐢𝐧-𝐖𝐨𝐨 𝐕𝐢𝐝𝐞𝐨`,
      notFound: "𝐤𝐨𝐧𝐨 𝐯𝐢𝐝𝐞𝐨 𝐩𝐚𝐰𝐚 𝐣𝐚𝐲 𝐧𝐚𝐢 ❌",
      error: "𝐀𝐢 𝐭𝐚 𝐤𝐢 𝐤𝐨𝐫𝐥𝐚 😒",
      blocked: "❌ 𝐘𝐨𝐮𝐫 𝐛𝐨𝐭 𝐢𝐬 𝐭𝐞𝐦𝐩𝐨𝐫𝐚𝐫𝐢𝐥𝐲 𝐮𝐧𝐬𝐞𝐧𝐝 𝐛𝐥𝐨𝐜𝐤"
    };

    let keyword = "son jin woo";
    if (args.length) keyword = `son jin woo ${args.join(" ")}`;
